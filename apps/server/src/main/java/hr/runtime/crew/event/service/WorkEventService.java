...
public class WorkEventService {
    ...
    @Transactional
    public EventResponse createEvent(Long teamId, CreateEventRequest request) {
        ...
        if (request.participantIds() != null && !request.participantIds().isEmpty()) {
            for (Long employeeId : request.participantIds()) {
    ...
    public List<EventResponse> getEventsByTeam(Long teamId, Instant from, Instant to) {
    ...
    @Transactional
    public void addParticipant(Long eventId, Long employeeId) {
        WorkEvent event = workEventRepository.findById(eventId)
                .orElseThrow(() -> new RuntimeException("Event not found"));
    ...
    public List<Long> getEventParticipantIds(Long eventId) {
    ...
    private EventResponse toResponse(WorkEvent event) {
        List<Long> participantIds = getEventParticipantIds(event.getId());
